...
SELECT countrylanguages.language AS language, countrylanguages.isofficial AS official
FROM countries
JOIN countrylanguages ON countries.code = countrylanguages.countrycode
WHERE countries.code = 'VAT';

-- Clue #3: We have new news on the classes Carmen attended – our gumshoes tell us she's moved on to a different country, a country where people speak only the language she was learning. Find out which nearby country speaks nothing but that language.

-- Write SQL query here

SELECT countries.name AS name, countrylanguages.language AS language, countrylanguages.isofficial AS official, countrylanguages.percentage AS speakers
FROM countries
JOIN countrylanguages ON countries.code = countrylanguages.countrycode
WHERE countrylanguages.language = 'Italian'
ORDER BY countrylanguages.percentage DESC limit 5;

-- or WHERE countrylanguages.language = 'Italian' AND countrylanguages.percentage = 100;
...
-- or WHERE countries.name = 'San Marino' AND cities.name != 'San Marino'
...
-- or WHERE cities.name LIKE 'Serra%' AND cities.name != 'Serravalle';
...
SELECT name FROM cities WHERE cities.population = 91084;